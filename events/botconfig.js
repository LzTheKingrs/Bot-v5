...
module.exports = {
  ...
  async execute(interaction, client) {
      ...
      interaction.update({
        ...
        embeds: [
          new Discord.EmbedBuilder()
            .setFooter({ text: "Feito por FroST" })
            .setDescription(
    ...
    if (interaction.isButton() && interaction.customId === "canal_config") {
      ...
      const duvida = await db.get(`canal_duvida_${interaction.guild.id}`);
        ...
        components: [
          ...
          new Discord.ActionRowBuilder().addComponents(
            ...
            new Discord.ButtonBuilder()
              ...
              .setStyle(Discord.ButtonStyle.Secondary),
              new Discord.ButtonBuilder()
              .setLabel("Duvida").setCustomId("duvida_button").setStyle(Discord.ButtonStyle.Secondary)
          ),
          update_button,
        ],
      });
    ...
    if (
      ...
      interaction.customId === "duvida_button"
    ) {
      ...
      collector.on("end", (collected) => {
        ...
        const channelId = collected.first().content;
        db.set(`canal_duvida_${interaction.guild.id}`, channelId);
